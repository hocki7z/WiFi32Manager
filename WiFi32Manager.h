/**************************************************************
  WiFi32Manager is a library for the ESP32 platform
  Created using code from (forked):
    Tzapu https://github.com/tzapu/WiFiManager
    Ken Taylor https://github.com/kentaylor
  Built by Edu Meneses https://github.com/edumeneses
...
const char HTTP_FORM_START[] PROGMEM      = "<form method=\"get\" action=\"wifisave\"><label>SSID</label><input id=\"s\" name=\"s\" length=32 placeholder=\"SSID\"><label>Password</label><input id=\"p\" name=\"p\" length=64 type=\"password\" placeholder=\"password\">";
...
class WiFiManager
{
  ...
  const char *myHostname = "192.168.4.1";
    ...
    auto optionalIPFromString(...) -> bool {
      DEBUG_WM("NO fromString METHOD ON IPAddress, you need ESP core 2.1.0 or newer for Custom IP configuration to work.");
      return false;
    }
};
